...
defmodule Seeds do
  ...
  def run do
    ...
    a = Repo.insert!(%User{ name: "Lee", email: "lee@gmail.com"})
    b = Repo.insert!(%User{ name: "yi", email: "yi@gmail.com"})
    c = Repo.insert!(%User{ name: "alice", email: "alice@gmail.com"})
    d = Repo.insert!(%User{ name: "carol", email: "carol@gmail.com"})
